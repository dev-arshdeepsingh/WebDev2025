...
//Now, whenever we use setCounter to update the value of counter then react will update it in whole page consistently.
  ...
  const addValue = () => {
    ...
    setCounter(counter + 1)
    setCounter(counter + 1) 
    setCounter(counter + 1)*/  //In this approach, the value of counter is not updating by 4 it is still increasing by 1. It is because the value of counter is not updated immediately. It is updated after the function is executed. So the counter is still 15 until the function is executed. It's more like 15 +1 then again 15 + 1 because counter never incremented. So, we use prevCounter to update the value of counter immediately. //This all happens due to useState's behaviour of executing in batches which is functinality of fiber in react.
    ...
    setCounter(prevCounter => prevCounter + 1)  //prevCounter is just a variable name. It is not a keyword. It is the callback func. ie () => {}  which is used to update the value of counter immediately. It is like "This" keyword which points to current context.
    setCounter(prevCounter => prevCounter + 1)  //However it can be written without () & {}  too.
      //So when callback happens, the value is updated immediately. 
  }
